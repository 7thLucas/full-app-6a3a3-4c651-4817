...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "chatPingsPerHour",
      type: "number",
      required: true,
      label: "Autonomous Chat — Pings Per Hour",
      min: 1,
      max: 12,
    },
    {
      fieldName: "chatMaxCatchUpPings",
      type: "number",
      required: true,
      label: "Autonomous Chat — Max Catch-Up Messages on Return",
      min: 1,
      max: 12,
    },
    {
      fieldName: "chatPollIntervalSeconds",
      type: "number",
      required: true,
      label: "Autonomous Chat — Frontend Poll Interval (seconds)",
      min: 10,
      max: 300,
    },
    {
      fieldName: "chatBackgroundAdvanceMinutes",
      type: "number",
      required: true,
      label: "Autonomous Chat — Background Advance Interval (minutes)",
      min: 1,
      max: 1440,
    },
    {
